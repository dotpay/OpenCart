...
class ControllerExtensionPaymentDotpayNew extends Controller {
    ...
    public function index() {
        ...
        $data['action'] = HTTPS_SERVER . 'index.php?route='.$this->getExtensionName().'/preparing';
        ...
        $channelData['url_see_cards'] = HTTPS_SERVER . 'index.php?route='.$this->getExtensionName().'/ocmanage';
    ...
    public function preparing() {
        $this->load->language('payment/'.self::PLUGIN_NAME);
        $this->load->model(dirname(dirname($this->getExtensionName())).'/dotpay_info');
        $this->load->model('checkout/order');
        $this->load->library('dotpay/Gateway');
        $this->load->library('dotpay/Agreements');
    ...
    public function back() {
        ...
        $data['check_status_url'] = HTTPS_SERVER . 'index.php?route='.dirname($this->getExtensionName()).'/status';
    ...
    public function ocmanage() {
        ...
        $data['ocmanage_remove_url'] = HTTPS_SERVER . 'index.php?route='.dirname($this->getExtensionName()).'/ocremove';
        $data['cards'] = $cards;
